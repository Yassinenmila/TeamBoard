...
var VaporKeepAlive = /* @__PURE__ */ defineVaporComponent({
	name: "VaporKeepAlive",
	__isKeepAlive: true,
	props: {
		include: [
...
var currentSlotHasFallback = false;
var isInSlotFallback = false;
...
//#endregion
export { setDynamicEvents as $, stop as $a, toClassSet as $i, createVNode as $n, matches as $r, vModelRadio as $t, defineVaporAsyncComponent as A, ReactiveEffect as Aa, registerRuntimeCompiler as Ai, baseEmit as An, initCustomFormatter as Ar, handleMovedChildren as At, isVaporComponent as B, isReadonly as Ba, resolveTransitionHooks$1 as Bi, createAsyncComponentContext as Bn, isMemoSame as Br, setVarsOnNode as Bt, createKeyedFragment as C, withAsyncContext as Ca, popWarningContext as Ci, SchedulerJobFlags as Cn, h as Cr, createSSRApp as Ct, createTextNode as D, withMemo as Da, queueJob as Di, Text$1 as Dn, hydrateOnInteraction as Dr, ensureRenderer as Dt, createTemplateRefSetter as E, withDirectives as Ea, pushWarningContext as Ei, Teleport as En, hydrateOnIdle as Er, ensureHydrationRenderer as Et, delegateEvents as F, effectScope as Fa, resolveDirective as Fi, checkTransitionMode as Fn, isAsyncWrapper as Fr, normalizeContainer as Ft, remove as G, onWatcherCleanup as Ga, setIsHydratingEnabled$1 as Gi, createElementBlock as Gn, isTeleportDisabled as Gr, useCssModule as Gt, nthChild as H, isShallow as Ha, setCurrentInstance as Hi, createBlock as Hn, isRuntimeOnly as Hr, shouldSetAsPropForVueCE as Ht, getDefaultValue as I, getCurrentScope as Ia, resolveDynamicComponent as Ii, cloneVNode as In, isEmitListener as Ir, patchProp as It, setBlockHtml as J, readonly as Ja, shouldUpdateComponent as Ji, createPropsRestProxy as Jn, isVNode as Jr, useShadowRoot as Jt, renderEffect as K, proxyRefs as Ka, setRef as Ki, createHydrationRenderer as Kn, isTemplateNode as Kr, useCssVars as Kt, getRestElement as L, getCurrentWatcher as La, resolveFilter as Li, compatUtils as Ln, isHydrating as Lr, patchStyle as Lt, defineVaporCustomElement as M, TriggerOpTypes as Ma, renderSlot as Mi, baseResolveTransitionHooks as Mn, inject as Mr, hydrate as Mt, defineVaporSSRCustomElement as N, customRef as Na, resetShapeFlag as Ni, callWithAsyncErrorHandling as Nn, invalidateMount as Nr, initDirectivesForSSR as Nt, createVaporApp as O, withScopeId as Oa, queuePostFlushCb as Oi, activate as On, hydrateOnMediaQuery as Or, forceReflow as Ot, delegate as P, effect as Pa, resolveComponent as Pi, callWithErrorHandling as Pn, invokeDirectiveHook as Pr, nodeOps as Pt, setDOMProp as Q, shallowRef as Qa, startMeasure as Qi, createTextVNode as Qn, markAsyncBoundary as Qr, vModelDynamic as Qt, insert as R, isProxy as Ra, resolvePropValue as Ri, computed as Rn, isKeepAlive as Rr, render as Rt, createInvoker as S, watchSyncEffect as Sa, popScopeId as Si, NULL_DYNAMIC_COMPONENT as Sn, guardReactiveProps as Sr, createApp as St, createSlot as T, withDefaults as Ta, pushScopeId as Ti, Suspense as Tn, hasInjectionContext as Tr, defineSSRCustomElement as Tt, on as U, markRaw as Ua, setCurrentRenderingInstance as Ui, createCanSetSetupRefChecker as Un, isSetEqual as Ur, svgNS as Ut, next as V, isRef as Va, setBlockTracking as Vi, createBaseVNode as Vn, isMismatchAllowed as Vr, shouldSetAsProp as Vt, prepend as W, onScopeDispose as Wa, setDevtoolsHook as Wi, createCommentVNode as Wn, isTeleportDeferred as Wr, unsafeToTrustedHTML as Wt, setBlockText as X, shallowReactive as Xa, ssrContextKey as Xi, createSlots as Xn, knownTemplateRefs as Xr, vModelCheckboxInit as Xt, setBlockKey as Y, ref as Ya, simpleSetCurrentInstance as Yi, createRenderer as Yn, isValidHtmlOrSvgAttribute as Yr, vModelCheckbox as Yt, setClass as Z, shallowReadonly as Za, ssrUtils as Zi, createStaticVNode as Zn, leaveCbKey as Zr, vModelCheckboxUpdate as Zt, createComponentWithFallback as _, warnExtraneousAttributes as _a, onUpdated as _i, ErrorTypeStrings as _n, getComponentName as _r, VueElement as _t, VaporKeepAlive as a, useAttrs as aa, normalizeRef as ai, vModelTextUpdate as an, unref as ao, defineExpose as ar, setStyle as at, createForSlots as b, watchEffect as ba, performTransitionEnter as bi, MismatchTypes as bn, getInheritedScopeIds as br, baseUseCssVars as bt, VaporTransitionGroup as c, useModel as ca, onBeforeUnmount as ci, vShowOriginalDisplay as cn, normalizeClass as co, defineProps as cr, template as ct, applyRadioModel as d, useTemplateRef as da, onErrorCaptured as di, xlinkNS as dn, toDisplayString as do, devtoolsComponentAdded as dr, vaporInteropPlugin as dt, toHandlers as ea, mergeDefaults as ei, vModelSelect as en, toRaw as eo, currentInstance as er, setDynamicProps as et, applySelectModel as f, useTransitionState as fa, onMounted as fi, BaseTransition as fn, toHandlerKey as fo, endMeasure as fr, withVaporCtx as ft, createComponent as g, warn as ga, onUnmounted as gi, ErrorCodes as gn, getAttributeMismatch as gr, TransitionPropsValidators as gt, child as h, version as ha, onServerPrefetch as hi, DeprecationTypes as hn, flushOnAppMount as hr, TransitionGroup as ht, VaporFragment as i, useAsyncComponentState as ia, nextUid as ii, vModelTextInit as in, triggerRef as io, defineEmits as ir, setProp as it, defineVaporComponent as j, TrackOpTypes as ja, renderList as ji, baseNormalizePropsOptions as jn, initFeatureFlags as jr, hasCSSTransform as jt, createVaporSSRApp as k, EffectScope as ka, registerHMR as ki, assertNumber as kn, hydrateOnVisible as kr, getValue as kt, applyCheckboxModel as l, useSSRContext as la, onBeforeUpdate as li, withKeys as ln, normalizeProps as lo, defineSlots as lr, txt as lt, applyVShow as m, validateProps as ma, onRenderTriggered as mi, Comment$1 as mn, expose as mr, Transition as mt, DynamicFragment as n, transformVNodeArgs as na, mergeProps as ni, vModelSetSelected as nn, toRefs as no, defineAsyncComponent as nr, setHtml as nt, VaporTeleport as o, useId as oa, onActivated as oi, vShow as on, camelize as oo, defineModel as or, setText as ot, applyTextModel as p, validateComponentName as pa, onRenderTracked as pi, BaseTransitionPropsValidators as pn, ensureVaporSlotFallback as pr, withVaporDirectives as pt, setAttr as q, reactive as qa, setTransitionHooks as qi, createInternalObject as qn, isTemplateRefKey as qr, useHost as qt, VaporElement as r, unregisterHMR as ra, nextTick as ri, vModelText as rn, toValue as ro, defineComponent as rr, setInsertionState as rt, VaporTransition as s, useInstanceOption as sa, onBeforeMount as si, vShowHidden as sn, capitalize as so, defineOptions as sr, setValue as st, compile as t, toStyleMap as ta, mergeModels as ti, vModelSelectInit as tn, toRef as to, deactivate as tr, setElementText as tt, applyDynamicModel as u, useSlots as ua, onDeactivated as ui, withModifiers as un, normalizeStyle as uo, devtools as ur, useVaporCssVars as ut, createDynamicComponent as v, warnPropMismatch as va, openBlock as vi, Fragment as vn, getCurrentInstance as vr, VueElementBase as vt, createPlainElement as w, withCtx as wa, provide as wi, Static as wn, handleError as wr, defineCustomElement as wt, createIf as x, watchPostEffect as xa, performTransitionLeave as xi, MoveType as xn, getTransitionRawChildren as xr, callPendingCbs as xt, createFor as y, watch as ya, performAsyncHydrate as yi, KeepAlive as yn, getFunctionalFallthrough as yr, baseApplyTranslation as yt, isFragment as z, isReactive as za, resolveTarget as zi, createAppAPI as zn, isMapEqual as zr, resolveTransitionProps as zt };

//# sourceMappingURL=vue.runtime.esm-bundler-CVBQ_Hfm.js.map